...
class AssistentMethod {
  ...
  static Future<DirectionDetailsInfo?> obtainOriginToDestinationDirectionDetails(
    ...
    String UrlOriginToDestinationDirectionDetails = "https://maps.googleapis.com/maps/api/directions/json?"
      ...
      if (responseDirectionApi == "Error Occurred, Failed. No Response.") {
        ...
        directionDetailsInfo.encodedPoints = responseDirectionApi["routes"][0]["overview_polyline"]["points"];
